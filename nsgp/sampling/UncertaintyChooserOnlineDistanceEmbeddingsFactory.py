...
from nsgp.sampling.UncertaintyChooserOnlineDistanceEmbeddings import UncertaintyChooserOnlineDistanceEmbeddings


class UncertaintyChooserOnlineDistanceEmbeddingsFactory(PairChooserFactory):
    ...
    def create(self, n_pairs: int = 1, already_seen: Set[Node] = None) -> PairChooser:
        return UncertaintyChooserOnlineDistanceEmbeddings(n_pairs, already_seen, self.__normalization_func_name, self.__lambda_coeff)
