...
folder = 'D://Research//ML-PIE//gp_simulated//test_results_gp_cross_dataset_dropout//'

encodings = ['counts']
datasets = ['boston_restricted', 'heating']
...
columns_to_keep = ['accuracy', 'ground_truth_value']
...
hypervolume_dataframe.to_csv('cross_dataset_hypervolumes.csv', index=False)
