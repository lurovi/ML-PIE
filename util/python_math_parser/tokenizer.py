...
This implementation of tokenizer try to achieve:
...
Pre-knowledge:
    ...
    Tables are mainly collected from "chapter3 lexical analysis" of Compilers: Principles, Techniques, and Tools.
