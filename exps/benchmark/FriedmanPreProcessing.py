...
if __name__ == "__main__":
    ...
    random.seed(43)
    np.random.seed(43)
    X_dev, y_dev = make_friedman1(n_samples=400, n_features=7, noise=0.25, random_state=43)
    random.seed(44)
    np.random.seed(44)
    X_test, y_test = make_friedman1(n_samples=200, n_features=7, noise=0.25, random_state=44)
